...
import com.example.android.guardiannewsfeeddemo.NewsItem;
...
// This is in lesson 1, section 18)
...
public final class QueryUtils {
    ...
    public static ArrayList<NewsItem> extractNews() {
        ...
        ArrayList<NewsItem> newsItemData = new ArrayList<>();
        ...
        try {
            JSONObject initialJsonResponse = new JSONObject(SAMPLE_JSON_RESPONSE);
    ...
    public static List<NewsItem>getnewsItemData(String mUrl) {
        List<NewsItem> newsItemData = null;
        return newsItemData;
    }
}